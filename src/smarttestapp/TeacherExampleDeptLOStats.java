 ...
 * @author csc190
 */
public class TeacherExampleDeptLOStats extends Application {
    ...
    */
    ...
    public void start(Stage stage) {
        ...
        final Label label = new Label("DEPT - LEARNING OUTCOME STATS");//add the nametest variable - concatination
        ...
        vbox.getChildren().addAll(logoutButton, label, table, table2);
