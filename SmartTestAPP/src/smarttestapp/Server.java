 ...
 */
public class Server {
    public static void insertOutcome(String val){
        String qry = "INSERT INTO loutcome (val) VALUES( '"+ val +"')";
        Utils.execNonQuery(qry);
    }
    //public static void updateUser(String username, String val){
      //  String qry = "UPDATE loutcome SET val= '" + val +  "' WHERE name = '"+username+ "'";
       // Utils.execNonQuery(qry);
    //}
    ...
    public static void main(String [] args){
        String op = args[0];
        if(op.equals("uploadLearningOutcome")){
            insertOutcome(args[1]);
